...
<html>
	...
	{ 
		...
		{	
			...
			{
				$warnning_message="Update was unable to continue because GeoPlaces theme doesn't seem to be associated with your Templatic account. Please <a href='http://templatic.com/contact/' target='_blank'>contact us</a> if this message is showing in error.";
			}			
		}
	}else{
