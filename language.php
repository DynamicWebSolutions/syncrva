<?php 
define('RATING_MSG',__('Rate this by clicking a star below:','templatic'));
...
define('ALPHA_ORDER_TEXT','Alphabetical');
define('LATEST_ORDER_TEXT','Latest published');
define('RANDOM_ORDER_TEXT','Random');
define('READ_MORE_LABEL',__('Read more','templatic'));
...
define('PRINT1',__('Print','templatic'));
define('SPECIAL_OFFER',__('Special offer','templatic'));
...
define('SORT_BY',__('Sort by : ','templatic'));
define('ALL',__('All','templatic'));
...
define('WHAT_THINK_TEXT',__('What do you think?','templatic'));
...
define('POST_REVIEW',__('Post Your Review','templatic'));
...
define('REQUIRED',__('required','templatic'));
define('CMT_YOUR_NAME',__('Your name','templatic'));
define('CMT_EMAIL_TEXT',__('E-mail','templatic'));
/*comments.php EOF */

/* loop.php BOF */
define('SEARCH_RESULT_NOT_FOUND',__('Apologies, but no results were found for the requested archive. Perhaps searching will help find a related post.','templatic'));
define('VIEW_TEXT',__('View','templatic'));
define('MORE_TEXT',__('More','templatic'));
/* loop.php EOF */
...
/*tpl_sitemap.php BOF */
define('PAGE_TEXT',__('Pages','templatic'));
define('POST_TEXT',__('Posts','templatic'));
define('ARCHIVE_TEXT',__('Archives','templatic'));
define('CATGORIES_TEXT',__('Categories','templatic'));
...
define('TAGS_TEXT',__('Tags','templatic'));
define('TAGS_TEXT_HEAD',__('Tags','templatic'));
/*tpl_sitemap.php EOF */

/*search.php BOF */
define('CATEGORY_TEXT',__('Categories','templatic'));
define('SEARCH_CATEGORY_TITLE',__('Search results for category','templatic'));
define('SEARCH_AUTHOR_TITLE',__('Search results for author','templatic'));
define('SEARCH_DATE_TITLE',__('Search results for date','templatic'));
define('SEARCH_TITLE',__('Search result for ','templatic'));
/*search.php EOF */

/*Send inquiry module BOF */
/*popup_owner_frm.php BOF */
define('INQ_YOUR_NAME',__('Full name','templatic'));
define('INQ_YOUR_EMAIL',__('Your email','templatic'));
define('INQ_CONTACT',__('Contact number','templatic'));
define('INQ_SUBJECT',__('Subject','templatic'));
...
define('POST_EVENT_TITLE',__('Add event','templatic'));
define('RENEW_EVENT_TEXT',__('Renew event','templatic'));
define('EDIT_EVENT_TEXT',__('Update event','templatic'));
define('POST_PLACE_TITLE',__('Add place','templatic'));
define('RENEW_LISING_TEXT',__('Renew place','templatic'));
define('EDIT_LISING_TEXT',__('Update place','templatic'));
...
define('SELECT_PACKAGE_TEXT',__('Select Package','templatic'));
...
define('CONTACT_NAME_TEXT',__('User name','templatic'));
...
define('EVENT_CITY_TEXT',__('Select City','templatic'));
...
define('RECENT_PLACES_TEXT',__('Recent places','templatic'));
define('PUBLISHED_TEXT',__('Published','templatic'));
define('RECENT_EVENTS_TEXT',__('Recent events','templatic'));
define('ID_TEXT',__('ID','templatic'));
define('TITLE_TEXT',__('Title','templatic'));
define('AUTHOR_NAME_TEXT',__('Author name','templatic'));
define('CLAIMER_TEXT',__('Claimer name','templatic'));
define('CONTACT_NUM_TEXT',__('Contact number','templatic'));
define('ACTION_TEXT',__('Action','templatic'));
define('SELECT_CITY_TEXT',__('Select city','templatic'));
define('ALL_TEXT',__('All','templatic'));
...
define('EDIT_PROFILE_PAGE_TITLE',__('Account information','templatic'));
...
define('PRICE_TITLE',__('Title','templatic'));
define('PRICE_PKG',__('Package cost ','templatic'));
define('PRICE_STATUS',__('Status ','templatic'));
define('PRICE_DESC',__('Description ','templatic'));
define('PRICE_VAL',__('Billing period ','templatic'));
define('PRICE_TYPE',__('Post type ','templatic'));
define('PRICE_CAT',__('Post categoery','templatic'));
define('REC_PAY',__('Recurring payment','templatic'));
define('NO_CTA_PKG',__('Show this price package even when no category selected.','templatic'));
define('PAYPAL_MSG',__('Processing for PayPal, please wait...','templatic','templatic'));

/*Submit_place.php*/
define('IP_BLOCK',__('Your IP is blocked. You can not add a place.','templatic'));
...
/*tpl_splash.php*/
define('SELECT_CITY_TPL',__('Select City','templatic'));
define('SELECT_CITY_DESC_TPL',__('Select a city below to display places &amp; events related to that city.','templatic'));

/***Backend monetize/manage_settings/admin_manage_permission.php***/
define('DISABLE_ACCESS_TEXT',__('Disable backend access for','templatic'));
define('SAVE_ALL_CHANGES_TEXT',__('Save All Changes','templatic'));
...
define('TRANS_KEY_NOTE',__('Example : 1234567890','templatic'));
