...
<div id="framework_wrap" class="wrap">
    ...
    <div class="button_bar">
    	 <input type="button" value="<?php _e('Theme Guide','templatic') ?>" class="button-framework  theme_guide"  onclick="window.location.href='http://templatic.com/docs/geoplaces-v4-theme-guide/'" />
