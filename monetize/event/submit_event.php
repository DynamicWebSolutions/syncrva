...
if($event_desc=='')
{
	$event_desc = __("Enter description for your listing.");
}
if($_REQUEST['renew'])
{
...
<div class="breadcrumb_in"><a href="<?php echo site_url(); ?>"><?php _e('Home'); ?></a> &raquo; <?php echo $page_title; ?></div>
<?php } ?>
 ...
 <?php if(is_allow_user_register()){?>
	...
	dynamic_sidebar('below_registration'); } ?></div>
			...
			if($cat_display == 'select'){  ?>
			 ...
			 <form name="categoryform" id="categoryform" action="<?php echo site_url().'/?ptype=post_event'; ?>" method="post" >
