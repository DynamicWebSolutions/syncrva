...
<script type="text/javascript" src="si.files.js"></script>
				<?php $server = @$_SERVER['HTTP_REFERER']; 
				if(isset($server) && $server !='' && strstr($server,'wp-admin/admin.php')){
				?>
				...
				<?php }else{ 
						echo "<div class='error'>"; echo 'Hey ! This is wrong you can not directly access this URL.'; echo "</div>";
				 } ?>
