...
<p>'.__('To publish the property please transfer the amount of','templatic').' <u>[#order_amt#]</u> '.__('at our bank with the following information','templatic').' :</p><p>'.__('Bank Name','templatic').' : [#bank_name#]</p><p>'.__('Account Number','templatic').' : [#account_number#]</p><br><p>'.__('Please include the ID as reference','templatic').' :#[#orderId#]</p><p><a href="[#submited_information_link#]" >'.__('View your submitted listing','templatic').' &raquo;</a>
